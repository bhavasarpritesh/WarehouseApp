...
import in.bbd.pritesh.util.SaleOrderUtil;
import in.bbd.pritesh.view.CustomerInvoicePdf;
import in.bbd.pritesh.view.SaleOrderExcelView;
import in.bbd.pritesh.view.SaleOrderPdfView;
...
public class SaleOrderController {
	...
	private void addDorpDownUi(Model model) {
		...
		model.addAttribute("whUserTypes", whservice.getWhUserTypeByUserType("Customer"));
	}
